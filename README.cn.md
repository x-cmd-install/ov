...
![ov](https://repo.x-cmd.io/ov.svg?lang=zh)
...
合计: **33,599** 行代码（覆盖前 5 种语言、共 **125** 个文件）。
...
- **上游仓库**: <https://github.com/noborus/ov>
- **官网**: <https://noborus.github.io/ov>
- **许可证**: MIT
...
- **Star**: 2,018 · **Fork**: 50 · **开放 issue**: 121 · **贡献者**: 22

## 累计统计

- **发布数**: 81 · **已合并 PR**: 957 · **开放 PR**: 3 · **已关闭 issue**: 96 · **开放 issue**: 25 · **提交数**: 2754
...
在 [repology.org](https://repology.org/project/ov) 上共有 **37** 个发行版报告此项目。**11** 个 ✅ 已是最新上游版本，**18** 个 ⚠️ 使用旧版本。
...
ov 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `ov` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/ov.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T05:35:53Z._
